...
class StateSetSpec extends ObjectBehavior
{
    ...
    function it_should_not_allow_add_more_than_one_initial_state(State $state)
    {
    ...
    function it_should_append_state(State $state)
    {
        $state->getName()->shouldBeCalled()->willReturn('stateC');
        $state->getType()->shouldBeCalled()->willReturn(State::INITIAL);
    ...
    function it_should_get_initial_status(State $state)
    {
        $state->getName()->shouldBeCalled()->willReturn('stateC');
        $state->getType()->shouldBeCalled()->willReturn(State::INITIAL);
    ...
    function it_should_get_final_status(State $state)
    {
        $state->getName()->shouldBeCalled()->willReturn('stateD');
        $state->getType()->shouldBeCalled()->willReturn(State::FINAL);
    ...
    {
        $this->get('stateA')->shouldReturnAnInstanceOf(State::class);
